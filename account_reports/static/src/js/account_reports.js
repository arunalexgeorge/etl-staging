...
var accountReportsWidget = AbstractAction.extend({
    ...
    custom_events: {
        'partner_filter_changed': function(ev) {
             ...
             self.report_options.partner_states = ev.data.partner_states;
    ...
    render_searchview_buttons: function() {
        ...
        if (this.report_options.partner) {
            if (!this.partners_m2m_filter) {
                ...
                if ('partner_states' in this.report_options) {
                    fields['partner_states'] = {
                        label: _t('States'),
                        modelName: 'res.country.state',
                        value: this.report_options.partner_states.map(Number),
                    };
                }
                if (!_.isEmpty(fields)) {
