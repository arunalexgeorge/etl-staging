...
class AccountReport(models.Model):
    ...
    def _init_options_partner(self, options, previous_options=None):
        ...
        selected_state_ids = [int(st) for st in options['partner_states']]
        selected_states = selected_state_ids and self.env['res.country.state'].browse(selected_state_ids) or self.env['res.country.state']
        options['partner_states'] = selected_states.mapped('id')
    ...
    def _get_options_partner_domain(self, options):
        ...
        if options.get('partner_states'):
            partner_state_ids = [int(state) for state in options['partner_states']]
    ...
    def _get_options_initializers_forced_sequence_map(self):
        ...
        return {
            ...
            self._init_options_branch: 1060,
        }
    ...
    def export_to_pdf(self, options):
        ...
        print_mode_self = self.with_context(print_mode=True, allowed_branch_ids=branch_ids)
